...
#ifndef LSP_PLUG_IN_DSP_UINTS_UTIL_SYNCCHIRPPROCESSOR_H_
#define LSP_PLUG_IN_DSP_UINTS_UTIL_SYNCCHIRPPROCESSOR_H_
...
#endif /* LSP_PLUG_IN_DSP_UINTS_UTIL_SYNCCHIRPPROCESSOR_H_ */
