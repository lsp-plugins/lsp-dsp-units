...
namespace lsp
{
    namespace dspu
    {
        ...
        ssize_t Scene3D::add_vertex(const dsp::point3d_t *p)
        {
            obj_vertex_t *v;
        ...
        ssize_t Scene3D::add_normal(const dsp::vector3d_t *n)
        {
            obj_normal_t *an;
